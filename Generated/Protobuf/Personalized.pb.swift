...
public nonisolated struct Tieba_PersonalizedRequestData: @unchecked Sendable {
...
public nonisolated struct Tieba_PersonalizedRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Tieba_PersonalizedResponseData: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Tieba_PersonalizedResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Tieba_ThreadPersonalized: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct Tieba_DislikeReason: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
nonisolated extension Tieba_PersonalizedRequestData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PersonalizedRequestData"
  ...
  public static func ==(lhs: Tieba_PersonalizedRequestData, rhs: Tieba_PersonalizedRequestData) -> Bool {
...
nonisolated extension Tieba_PersonalizedRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PersonalizedRequest"
  ...
  public static func ==(lhs: Tieba_PersonalizedRequest, rhs: Tieba_PersonalizedRequest) -> Bool {
...
nonisolated extension Tieba_PersonalizedResponseData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PersonalizedResponseData"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}\u{2}thread_list\0\u{4}\u{5}thread_personalized\0")
  ...
  public static func ==(lhs: Tieba_PersonalizedResponseData, rhs: Tieba_PersonalizedResponseData) -> Bool {
...
nonisolated extension Tieba_PersonalizedResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PersonalizedResponse"
  ...
  public static func ==(lhs: Tieba_PersonalizedResponse, rhs: Tieba_PersonalizedResponse) -> Bool {
...
nonisolated extension Tieba_ThreadPersonalized: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ThreadPersonalized"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}tid\0\u{1}weight\0\u{1}source\0\u{2}\u{2}dislikeResource\0\u{1}extra\0")
  ...
  public static func ==(lhs: Tieba_ThreadPersonalized, rhs: Tieba_ThreadPersonalized) -> Bool {
...
nonisolated extension Tieba_DislikeReason: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DislikeReason"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}dislikeReason\0\u{1}dislikeId\0\u{1}extra\0")
  ...
  public static func ==(lhs: Tieba_DislikeReason, rhs: Tieba_DislikeReason) -> Bool {
