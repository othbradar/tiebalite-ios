...
public nonisolated struct Tieba_AppPosInfo: Sendable {
  ...
  public mutating func clearAddrTimestamp() {self._addrTimestamp = nil}
  ...
  public mutating func clearApConnected() {self._apConnected = nil}
  ...
  public mutating func clearApMac() {self._apMac = nil}
  ...
  public mutating func clearAspShownInfo() {self._aspShownInfo = nil}
  ...
  public mutating func clearCoordinateType() {self._coordinateType = nil}
...
nonisolated extension Tieba_AppPosInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AppPosInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}ap_mac\0\u{3}ap_connected\0\u{3}coordinate_type\0\u{4}\u{3}addr_timestamp\0\u{3}asp_shown_info\0")
  ...
  public static func ==(lhs: Tieba_AppPosInfo, rhs: Tieba_AppPosInfo) -> Bool {
