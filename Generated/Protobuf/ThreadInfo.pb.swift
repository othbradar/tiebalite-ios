...
public nonisolated struct Tieba_ThreadInfo: @unchecked Sendable {
  ...
  public mutating func clearLastReplyer() {_uniqueStorage()._lastReplyer = nil}
  ...
  public mutating func clearForumInfo() {_uniqueStorage()._forumInfo = nil}
...
nonisolated extension Tieba_ThreadInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ThreadInfo"
  ...
  public static func ==(lhs: Tieba_ThreadInfo, rhs: Tieba_ThreadInfo) -> Bool {
