...
public nonisolated struct Tieba_CommonRequest: @unchecked Sendable {
  ...
  public mutating func clearBduss() {_uniqueStorage()._bduss = nil}
  ...
  public mutating func clearTbs() {_uniqueStorage()._tbs = nil}
  ...
  public mutating func clearSign() {_uniqueStorage()._sign = nil}
  ...
  public mutating func clearStoken() {_uniqueStorage()._stoken = nil}
  ...
  public mutating func clearZID() {_uniqueStorage()._zID = nil}
  ...
  public mutating func clearCuidGid() {_uniqueStorage()._cuidGid = nil}
  ...
  public mutating func clearOaid() {_uniqueStorage()._oaid = nil}
  ...
  public mutating func clearSampleID() {_uniqueStorage()._sampleID = nil}
  ...
  public mutating func clearQType() {_uniqueStorage()._qType = nil}
  ...
  public mutating func clearIsTeenager() {_uniqueStorage()._isTeenager = nil}
  ...
  public var swanGameVer: String {
    get {_storage._swanGameVer}
    set {_uniqueStorage()._swanGameVer = newValue}
  }
  ...
  public mutating func clearStartScheme() {_uniqueStorage()._startScheme = nil}
...
nonisolated extension Tieba_CommonRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _swanGameVer: String = String()
    ...
    init(copying source: _StorageClass) {
      ...
      _swanGameVer = source._swanGameVer
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 44: try { try decoder.decodeSingularStringField(value: &_storage._swanGameVer) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._swanGameVer.isEmpty {
        try visitor.visitSingularStringField(value: _storage._swanGameVer, fieldNumber: 44)
      }
  ...
  public static func ==(lhs: Tieba_CommonRequest, rhs: Tieba_CommonRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._swanGameVer != rhs_storage._swanGameVer {return false}
