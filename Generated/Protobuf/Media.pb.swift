...
public nonisolated struct Tieba_Media: Sendable {
...
nonisolated extension Tieba_Media: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{2}\u{2}bigPic\0\u{2}\u{5}srcPic\0\u{2}\u{2}width\0\u{1}height\0\u{2}\u{4}originPic\0\u{1}originSize\0\u{1}postId\0\u{1}dynamicPic\0\u{1}isLongPic\0\u{1}showOriginalBtn\0")
  ...
  public static func ==(lhs: Tieba_Media, rhs: Tieba_Media) -> Bool {
