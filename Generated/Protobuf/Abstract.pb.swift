...
public nonisolated struct Tieba_Abstract: Sendable {
  ...
  public var un: String = String()

  public var duringTime: String = String()

  public var voiceMd5: String = String()
...
nonisolated extension Tieba_Abstract: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Abstract"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}text\0\u{1}link\0\u{1}src\0\u{1}un\0\u{1}duringTime\0\u{1}voiceMD5\0")
  ...
  public static func ==(lhs: Tieba_Abstract, rhs: Tieba_Abstract) -> Bool {
