...
public nonisolated struct Tieba_PbPage_PbSortType: Sendable {
...
nonisolated extension Tieba_PbPage_PbSortType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbSortType"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}sort_type\0\u{3}sort_name\0")
  ...
  public static func ==(lhs: Tieba_PbPage_PbSortType, rhs: Tieba_PbPage_PbSortType) -> Bool {
