...
public nonisolated struct Tieba_PbPage_PbPageResponse: Sendable {
...
nonisolated extension Tieba_PbPage_PbPageResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbPageResponse"
  ...
  public static func ==(lhs: Tieba_PbPage_PbPageResponse, rhs: Tieba_PbPage_PbPageResponse) -> Bool {
