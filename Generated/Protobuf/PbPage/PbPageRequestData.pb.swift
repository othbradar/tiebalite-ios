...
public nonisolated struct Tieba_PbPage_PbPageRequestData: @unchecked Sendable {
  ...
  public mutating func clearPbRn() {_uniqueStorage()._pbRn = nil}
  ...
  public mutating func clearWeipost() {_uniqueStorage()._weipost = nil}
  ...
  public mutating func clearSModel() {_uniqueStorage()._sModel = nil}
  ...
  public mutating func clearThreadType() {_uniqueStorage()._threadType = nil}
  ...
  public mutating func clearIsCommReverse() {_uniqueStorage()._isCommReverse = nil}
  ...
  public mutating func clearIsJumpfloor() {_uniqueStorage()._isJumpfloor = nil}
  ...
  public mutating func clearJumpfloorNum() {_uniqueStorage()._jumpfloorNum = nil}
  ...
  public mutating func clearObjParam1() {_uniqueStorage()._objParam1 = nil}
  ...
  public mutating func clearFromSmartFrs() {_uniqueStorage()._fromSmartFrs = nil}
  ...
  public mutating func clearForumID() {_uniqueStorage()._forumID = nil}
  ...
  public mutating func clearNeedRepostRecommendForum() {_uniqueStorage()._needRepostRecommendForum = nil}
  ...
  public mutating func clearOriUgcType() {_uniqueStorage()._oriUgcType = nil}
  ...
  public mutating func clearFromPush() {_uniqueStorage()._fromPush = nil}
  ...
  public mutating func clearImmersionVideoCommentSource() {_uniqueStorage()._immersionVideoCommentSource = nil}
  ...
  public mutating func clearAppTransmitData() {_uniqueStorage()._appTransmitData = nil}
  ...
  public mutating func clearIsFoldCommentReq() {_uniqueStorage()._isFoldCommentReq = nil}
  ...
  public mutating func clearIsEditCommentReq() {_uniqueStorage()._isEditCommentReq = nil}
  ...
  public mutating func clearSimilarFrom() {_uniqueStorage()._similarFrom = nil}
...
nonisolated extension Tieba_PbPage_PbPageRequestData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbPageRequestData"
  ...
  public static func ==(lhs: Tieba_PbPage_PbPageRequestData, rhs: Tieba_PbPage_PbPageRequestData) -> Bool {
