...
// Source: PbPage/GuessLikeStruct.proto
//
...
public nonisolated struct Tieba_PbPage_GuessLikeStruct: Sendable {
...
nonisolated extension Tieba_PbPage_GuessLikeStruct: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GuessLikeStruct"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}title\0\u{3}thread_list\0")
  ...
  public static func ==(lhs: Tieba_PbPage_GuessLikeStruct, rhs: Tieba_PbPage_GuessLikeStruct) -> Bool {
