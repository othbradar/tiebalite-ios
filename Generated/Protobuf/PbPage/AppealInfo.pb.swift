...
public nonisolated struct Tieba_PbPage_AppealInfo: Sendable {
...
nonisolated extension Tieba_PbPage_AppealInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}source\0\u{3}appeal_url\0")
  ...
  public static func ==(lhs: Tieba_PbPage_AppealInfo, rhs: Tieba_PbPage_AppealInfo) -> Bool {
