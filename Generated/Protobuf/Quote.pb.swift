...
public nonisolated struct Tieba_Quote: Sendable {
...
nonisolated extension Tieba_Quote: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}post_id\0\u{3}user_name\0\u{3}user_id\0\u{1}ip\0\u{1}content\0")
  ...
  public static func ==(lhs: Tieba_Quote, rhs: Tieba_Quote) -> Bool {
