...
public nonisolated struct Tieba_Error: Sendable {
...
nonisolated extension Tieba_Error: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}error_code\0\u{3}error_msg\0\u{3}user_msg\0")
  ...
  public static func ==(lhs: Tieba_Error, rhs: Tieba_Error) -> Bool {
