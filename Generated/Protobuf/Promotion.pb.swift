...
public nonisolated struct Tieba_Promotion: Sendable {
...
nonisolated extension Tieba_Promotion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}title\0\u{3}sub_title\0\u{1}image\0\u{1}link\0\u{3}link_text\0\u{3}appear_time\0")
  ...
  public static func ==(lhs: Tieba_Promotion, rhs: Tieba_Promotion) -> Bool {
