...
public nonisolated struct Tieba_DealWindow: Sendable {
...
nonisolated extension Tieba_DealWindow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DealWindow"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}list\0\u{1}total\0")
  ...
  public static func ==(lhs: Tieba_DealWindow, rhs: Tieba_DealWindow) -> Bool {
