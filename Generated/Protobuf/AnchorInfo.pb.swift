...
public nonisolated struct Tieba_AnchorInfo: @unchecked Sendable {
...
nonisolated extension Tieba_AnchorInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AnchorInfo"
  ...
  public static func ==(lhs: Tieba_AnchorInfo, rhs: Tieba_AnchorInfo) -> Bool {
