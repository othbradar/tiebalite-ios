...
public nonisolated struct Tieba_Page: Sendable {
...
nonisolated extension Tieba_Page: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}page_size\0\u{1}offset\0\u{3}current_page\0\u{3}total_count\0\u{3}total_page\0\u{3}has_more\0\u{3}has_prev\0\u{3}cur_good_id\0\u{3}req_num\0\u{1}pnum\0\u{1}tnum\0\u{3}total_num\0\u{3}lz_total_floor\0\u{3}new_total_page\0")
  ...
  public static func ==(lhs: Tieba_Page, rhs: Tieba_Page) -> Bool {
