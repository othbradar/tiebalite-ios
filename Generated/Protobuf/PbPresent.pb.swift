...
public nonisolated struct Tieba_PbPresent: Sendable {
...
nonisolated extension Tieba_PbPresent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PbPresent"
  ...
  public static func ==(lhs: Tieba_PbPresent, rhs: Tieba_PbPresent) -> Bool {
