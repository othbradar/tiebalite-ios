...
public nonisolated struct Tieba_BazhuSign: Sendable {
...
nonisolated extension Tieba_BazhuSign: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".BazhuSign"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}desc\0\u{1}level\0")
  ...
  public static func ==(lhs: Tieba_BazhuSign, rhs: Tieba_BazhuSign) -> Bool {
