...
public nonisolated struct Tieba_DislikeInfo: Sendable {
...
nonisolated extension Tieba_DislikeInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DislikeInfo"
  ...
  public static func ==(lhs: Tieba_DislikeInfo, rhs: Tieba_DislikeInfo) -> Bool {
