...
public nonisolated struct Tieba_FrsPage_VideoImageColor: Sendable {
...
nonisolated extension Tieba_FrsPage_VideoImageColor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".VideoImageColor"
  ...
  public static func ==(lhs: Tieba_FrsPage_VideoImageColor, rhs: Tieba_FrsPage_VideoImageColor) -> Bool {
