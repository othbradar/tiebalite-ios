...
public nonisolated struct Tieba_FrsPage_AdParam: Sendable {
...
nonisolated extension Tieba_FrsPage_AdParam: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AdParam"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}load_count\0\u{3}refresh_count\0\u{3}yoga_lib_version\0")
  ...
  public static func ==(lhs: Tieba_FrsPage_AdParam, rhs: Tieba_FrsPage_AdParam) -> Bool {
