...
public nonisolated struct Tieba_FrsPage_SignInfo: @unchecked Sendable {
...
nonisolated extension Tieba_FrsPage_SignInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SignInfo"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}user_info\0\u{3}forum_info\0")
  ...
  public static func ==(lhs: Tieba_FrsPage_SignInfo, rhs: Tieba_FrsPage_SignInfo) -> Bool {
