...
public nonisolated struct Tieba_FrsPage_Classify: Sendable {
...
nonisolated extension Tieba_FrsPage_Classify: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Classify"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}name\0\u{1}id\0\u{3}class_id\0\u{3}class_name\0")
  ...
  public static func ==(lhs: Tieba_FrsPage_Classify, rhs: Tieba_FrsPage_Classify) -> Bool {
