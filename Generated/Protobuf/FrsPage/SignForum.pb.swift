...
public nonisolated struct Tieba_FrsPage_SignForum: Sendable {
  ...
  public mutating func clearForumInfo() {self._forumInfo = nil}
  ...
  public mutating func clearCurrentRankInfo() {self._currentRankInfo = nil}
...
nonisolated extension Tieba_FrsPage_SignForum: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SignForum"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}is_on\0\u{3}is_filter\0\u{3}forum_info\0\u{3}current_rank_info\0")
  ...
  public static func ==(lhs: Tieba_FrsPage_SignForum, rhs: Tieba_FrsPage_SignForum) -> Bool {
