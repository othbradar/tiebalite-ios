...
public nonisolated struct Tieba_Anti: Sendable {
...
nonisolated extension Tieba_Anti: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Anti"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}tbs\0\u{1}ifpost\0\u{1}ifposta\0\u{3}forbid_flag\0\u{3}forbid_info\0\u{3}block_stat\0\u{3}hide_stat\0\u{3}vcode_stat\0\u{3}days_tofree\0\u{3}has_chance\0\u{1}ifvoice\0\u{4}\u{d}del_thread_text\0")
  ...
  public static func ==(lhs: Tieba_Anti, rhs: Tieba_Anti) -> Bool {
