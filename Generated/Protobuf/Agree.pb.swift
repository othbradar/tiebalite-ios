...
public nonisolated struct Tieba_Agree: Sendable {
...
nonisolated extension Tieba_Agree: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Agree"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}agreeNum\0\u{1}hasAgree\0\u{1}agreeType\0\u{1}disagreeNum\0\u{1}diffAgreeNum\0")
  ...
  public static func ==(lhs: Tieba_Agree, rhs: Tieba_Agree) -> Bool {
