...
public nonisolated struct Tieba_VideoInfo: Sendable {
...
nonisolated extension Tieba_VideoInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}videoMD5\0\u{1}videoUrl\0\u{1}videoDuration\0\u{1}videoWidth\0\u{1}videoHeight\0\u{1}thumbnailUrl\0\u{1}thumbnailWidth\0\u{1}thumbnailHeight\0\u{2}\u{3}mediaSubtitle\0")
  ...
  public static func ==(lhs: Tieba_VideoInfo, rhs: Tieba_VideoInfo) -> Bool {
