...
public nonisolated struct Tieba_LinkInfo: Sendable {
...
nonisolated extension Tieba_LinkInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}desc\0\u{1}link\0\u{1}type\0")
  ...
  public static func ==(lhs: Tieba_LinkInfo, rhs: Tieba_LinkInfo) -> Bool {
