...
public nonisolated struct Tieba_Icon: Sendable {
...
nonisolated extension Tieba_Icon: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}name\0\u{1}weight\0\u{1}url\0\u{1}icon\0\u{1}value\0\u{1}terminal\0\u{1}position\0\u{3}sprite_info\0")
  ...
  public static func ==(lhs: Tieba_Icon, rhs: Tieba_Icon) -> Bool {
