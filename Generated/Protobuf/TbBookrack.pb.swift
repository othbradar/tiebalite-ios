...
public nonisolated struct Tieba_TbBookrack: Sendable {
...
nonisolated extension Tieba_TbBookrack: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TbBookrack"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}booktown\0\u{1}num\0\u{3}book_list\0\u{1}title\0\u{1}icon\0\u{1}tip\0")
  ...
  public static func ==(lhs: Tieba_TbBookrack, rhs: Tieba_TbBookrack) -> Bool {
