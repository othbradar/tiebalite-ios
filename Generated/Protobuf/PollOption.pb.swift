...
public nonisolated struct Tieba_PollOption: Sendable {
...
nonisolated extension Tieba_PollOption: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PollOption"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}num\0\u{1}text\0\u{1}image\0")
  ...
  public static func ==(lhs: Tieba_PollOption, rhs: Tieba_PollOption) -> Bool {
