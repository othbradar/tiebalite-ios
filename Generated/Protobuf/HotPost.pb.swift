...
public nonisolated struct Tieba_HotPost: Sendable {
  ...
  public mutating func clearPostZan() {self._postZan = nil}
...
nonisolated extension Tieba_HotPost: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HotPost"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}thread_id\0\u{3}post_id\0\u{3}user_name\0\u{3}user_id\0\u{3}post_zan\0\u{3}post_num\0\u{1}content\0\u{3}create_time\0\u{1}floor\0\u{1}portrait\0")
  ...
  public static func ==(lhs: Tieba_HotPost, rhs: Tieba_HotPost) -> Bool {
